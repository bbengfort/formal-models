...
\@x{}\moduleLeftDash\@xx{ {\MODULE} philosophers}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\end{cpar}%
\end{lcom}%
\@x{ {\EXTENDS} TLC ,\, Integers ,\, Sequences ,\, FiniteSets}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ {\CONSTANT} NPhilosophers}%
\@x{ {\ASSUME} NPhilosophers \.{\in} Nat}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{ a \.{\,\%\%\,} b \.{\defeq} {\IF} a \.{\%} b \.{=} 0 \.{\THEN} b
 \.{\ELSE} a \.{\%} b}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{PlusCal} is used to implement the philosophers algorithm
}%
\@xx{}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{8.2} {\p@mmalgorithm} dining}%
\@x{ {\p@variables}}%
 \@x{\@s{8.2} sticks \.{=} [ x \.{\in} 1 \.{\dotdot} NPhilosophers \.{\mapsto}
 {\FALSE} ] {\p@semicolon}}%
\@y{\@s{0}%
 one stick per philosopher, each starting unused (down)
}%
\@xx{}%
\@pvspace{16.0pt}%
\@x{ {\p@define}}%
\@x{\@s{8.2}}%
\@y{\@s{0}%
 A stick is available if it\mbox{'}s unused (\ensuremath{{\FALSE}})
}%
\@xx{}%
\@x{\@s{8.2} StickAvailable ( stick ) \.{\defeq} {\lnot} sticks [ stick ]}%
\@x{ {\p@end} {\p@define} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@macro} pickup ( stick ) {\p@begin}}%
\@x{\@s{8.2} sticks [ stick ] \.{:=} {\TRUE} {\p@semicolon}}%
\@x{ {\p@end} {\p@macro} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@macro} putdown ( stick ) {\p@begin}}%
\@x{\@s{8.2} sticks [ stick ] \.{:=} {\FALSE}}%
\@x{ {\p@end} {\p@macro} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 cannot do \ensuremath{putdown(left) \.{\p@barbar} putdown(right)}; so this
 is a helper.
}%
\@xx{}%
\@x{}%
...
\@xx{}%
\@x{ {\p@macro} putdown\_both ( ) {\p@begin}}%
 \@x{\@s{8.2} sticks [ first ] \.{:=} {\FALSE}\@s{4.1} \.{\p@barbar} sticks [
 second ] \.{:=} {\FALSE} {\p@semicolon}}%
\@x{ {\p@end} {\p@macro} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ {\p@procedure} eat ( first \.{=} 0 ,\, second \.{=} 0 ) {\p@begin}}%
\@x{\@s{8.2} PickUpFirst\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{16.4} {\p@await} StickAvailable ( first ) {\p@semicolon}}%
\@x{\@s{16.4} pickup ( first ) {\p@semicolon}}%
\@x{\@s{8.2} PickUpSecond\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{16.4} {\p@if} StickAvailable ( second ) {\p@then}}%
\@x{\@s{24.59} pickup ( second ) {\p@semicolon}}%
\@x{\@s{16.4} {\p@else}}%
\@x{\@s{24.59} putdown ( first ) {\p@semicolon}}%
\@x{\@s{24.59} {\p@goto} PickUpFirst}%
\@x{\@s{16.4} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{8.2} Eat\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{16.4} {\p@skip} {\p@semicolon}}%
\@x{\@s{8.2} Finish\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{16.4} putdown\_both ( ) {\p@semicolon}}%
\@x{\@s{8.2} {\p@return} {\p@semicolon}}%
\@x{ {\p@end} {\p@procedure} {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{ {\p@fair} {\p@process} philosopher \.{\in} 1 \.{\dotdot} ( NPhilosophers
 \.{-} 1 )}%
\@x{ {\p@variables}}%
 \@x{\@s{8.2} left \.{=} {\IF} self \.{>} 1 \.{\THEN} self \.{-} 1 \.{\ELSE}
 Len ( sticks ) {\p@semicolon}}%
\@x{\@s{8.2} right \.{=} self {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@begin}}%
\@x{ RHPhilsopher\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{8.2} {\p@call} eat ( left ,\, right ) {\p@semicolon}}%
\@x{ {\p@end} {\p@process} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@fair} {\p@process} lh\_philosopher \.{\in} \{ NPhilosophers \}}%
\@x{ {\p@variables}}%
 \@x{\@s{8.2} left \.{=} {\IF} self \.{>} 1 \.{\THEN} self \.{-} 1 \.{\ELSE}
 Len ( sticks ) {\p@semicolon}}%
\@x{\@s{8.2} right \.{=} self {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@begin}}%
\@x{ LHPhilsopher\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{8.2} {\p@call} eat ( right ,\, left ) {\p@semicolon}}%
\@x{ {\p@end} {\p@process} {\p@semicolon}}%
\@pvspace{16.0pt}%
\@x{ {\p@end} {\p@algorithm}}%
\@y{%
...
\@x{}%
\@y{\@s{0}%
 Process variable left of process philosopher at line 69 col 3 changed to
 \ensuremath{left\_
}}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 Process variable right of process philosopher at line 70 col 3 changed to
 \ensuremath{right\_
}}%
\@xx{}%
\@x{ {\VARIABLES} sticks ,\, pc ,\, stack}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 define statement
...
\@xx{}%
\@x{ StickAvailable ( stick ) \.{\defeq} {\lnot} sticks [ stick ]}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} first ,\, second ,\, left\_ ,\, right\_ ,\, left ,\, right}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} sticks ,\, pc ,\, stack ,\, first ,\, second
 ,\, left\_ ,\, right\_ ,\, left ,\, right {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ ProcSet \.{\defeq} ( 1 \.{\dotdot} ( NPhilosophers \.{-} 1 ) ) \.{\cup}
 ( \{ NPhilosophers \} )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} sticks \.{=} [ x \.{\in} 1 \.{\dotdot} NPhilosophers
 \.{\mapsto} {\FALSE} ]}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Procedure eat
...
\@xx{}%
\@x{\@s{35.70} \.{\land} first \.{=} [ self \.{\in} ProcSet \.{\mapsto} 0 ]}%
\@x{\@s{35.70} \.{\land} second \.{=} [ self \.{\in} ProcSet \.{\mapsto} 0 ]}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process philosopher
}%
\@xx{}%
 \@x{\@s{35.70} \.{\land} left\_ \.{=} [ self \.{\in} 1 \.{\dotdot} (
 NPhilosophers \.{-} 1 ) \.{\mapsto} {\IF} self \.{>} 1 \.{\THEN} self \.{-}
 1 \.{\ELSE} Len ( sticks ) ]}%
 \@x{\@s{35.70} \.{\land} right\_ \.{=} [ self \.{\in} 1 \.{\dotdot} (
 NPhilosophers \.{-} 1 ) \.{\mapsto} self ]}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process \ensuremath{lh\_philosopher
}}%
\@xx{}%
 \@x{\@s{35.70} \.{\land} left \.{=} [ self \.{\in} \{ NPhilosophers \}
 \.{\mapsto} {\IF} self \.{>} 1 \.{\THEN} self \.{-} 1 \.{\ELSE} Len ( sticks
 ) ]}%
 \@x{\@s{35.70} \.{\land} right\@s{1.53} \.{=} [ self \.{\in} \{ NPhilosophers
 \} \.{\mapsto} self ]}%
 \@x{\@s{35.70} \.{\land} stack \.{=} [ self \.{\in} ProcSet \.{\mapsto}
 {\langle} {\rangle} ]}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto} {\CASE}
 self \.{\in} 1 \.{\dotdot} ( NPhilosophers \.{-} 1 )
 \.{\rightarrow}\@w{RHPhilsopher}}%
 \@x{\@s{160.39} {\Box}\@s{10.30} self \.{\in} \{ NPhilosophers \}
 \.{\rightarrow}\@w{LHPhilsopher} ]}%
\@pvspace{8.0pt}%
 \@x{ PickUpFirst ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{PickUpFirst}}%
\@x{\@s{96.86} \.{\land} StickAvailable ( first [ self ] )}%
 \@x{\@s{96.86} \.{\land} sticks \.{'} \.{=} [ sticks {\EXCEPT} {\bang} [
 first [ self ] ] \.{=} {\TRUE} ]}%
 \@x{\@s{96.86} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{PickUpSecond} ]}%
 \@x{\@s{96.86} \.{\land} {\UNCHANGED} {\langle} stack ,\, first ,\, second
 ,\, left\_ ,\, right\_ ,\, left ,\,}%
\@x{\@s{170.45} right {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ PickUpSecond ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{PickUpSecond}}%
\@x{\@s{105.36} \.{\land} {\IF} StickAvailable ( second [ self ] )}%
 \@x{\@s{128.63} \.{\THEN} \.{\land} sticks \.{'} \.{=} [ sticks {\EXCEPT}
 {\bang} [ second [ self ] ] \.{=} {\TRUE} ]}%
 \@x{\@s{159.94} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Eat} ]}%
 \@x{\@s{128.63} \.{\ELSE} \.{\land} sticks \.{'} \.{=} [ sticks {\EXCEPT}
 {\bang} [ first [ self ] ] \.{=} {\FALSE} ]}%
 \@x{\@s{159.94} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{PickUpFirst} ]}%
 \@x{\@s{105.36} \.{\land} {\UNCHANGED} {\langle} stack ,\, first ,\, second
 ,\, left\_ ,\, right\_ ,\,}%
\@x{\@s{178.95} left ,\, right {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Eat ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{Eat}}%
\@x{\@s{59.26} \.{\land} {\TRUE}}%
 \@x{\@s{59.26} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Finish} ]}%
 \@x{\@s{59.26} \.{\land} {\UNCHANGED} {\langle} sticks ,\, stack ,\, first
 ,\, second ,\, left\_ ,\, right\_ ,\, left ,\,}%
\@x{\@s{132.85} right {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Finish ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{Finish}}%
 \@x{\@s{71.34} \.{\land} sticks \.{'} \.{=} [ sticks {\EXCEPT} {\bang} [
 first [ self ] ] \.{=} {\FALSE} ,\,}%
\@x{\@s{192.57} {\bang} [ second [ self ] ] \.{=} {\FALSE} ]}%
 \@x{\@s{71.34} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ] \.{=}
 Head ( stack [ self ] ) . pc ]}%
 \@x{\@s{71.34} \.{\land} first \.{'} \.{=} [ first {\EXCEPT} {\bang} [ self ]
 \.{=} Head ( stack [ self ] ) . first ]}%
 \@x{\@s{71.34} \.{\land} second \.{'} \.{=} [ second {\EXCEPT} {\bang} [ self
 ] \.{=} Head ( stack [ self ] ) . second ]}%
 \@x{\@s{71.34} \.{\land} stack \.{'} \.{=} [ stack {\EXCEPT} {\bang} [ self ]
 \.{=} Tail ( stack [ self ] ) ]}%
 \@x{\@s{71.34} \.{\land} {\UNCHANGED} {\langle} left\_ ,\, right\_ ,\, left
 ,\, right {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ eat ( self ) \.{\defeq} PickUpFirst ( self ) \.{\lor} PickUpSecond (
 self ) \.{\lor} Eat ( self )}%
\@x{\@s{68.86} \.{\lor} Finish ( self )}%
\@pvspace{8.0pt}%
 \@x{ RHPhilsopher ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{RHPhilsopher}}%
 \@x{\@s{104.65} \.{\land} \.{\land} first \.{'} \.{=} [ first {\EXCEPT}
 {\bang} [ self ] \.{=} left\_ [ self ] ]}%
 \@x{\@s{115.76} \.{\land} second \.{'} \.{=} [ second {\EXCEPT} {\bang} [
 self ] \.{=} right\_ [ self ] ]}%
 \@x{\@s{115.76} \.{\land} stack \.{'} \.{=} [ stack {\EXCEPT} {\bang} [ self
 ] \.{=} {\langle} [ procedure \.{\mapsto}\@s{4.1}\@w{eat} ,\,}%
\@x{\@s{279.96} pc\@s{31.67} \.{\mapsto}\@s{3.78}\@w{Done} ,\,}%
\@x{\@s{279.96} first\@s{23.24} \.{\mapsto}\@s{4.1} first [ self ] ,\,}%
 \@x{\@s{279.96} second\@s{11.98} \.{\mapsto}\@s{4.1} second [ self ] ]
 {\rangle}}%
\@x{\@s{277.40} \.{\circ} stack [ self ] ]}%
 \@x{\@s{104.65} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{PickUpFirst} ]}%
 \@x{\@s{104.65} \.{\land} {\UNCHANGED} {\langle} sticks ,\, left\_ ,\,
 right\_ ,\, left ,\, right {\rangle}}%
\@pvspace{8.0pt}%
\@x{ philosopher ( self ) \.{\defeq} RHPhilsopher ( self )}%
\@pvspace{8.0pt}%
 \@x{ LHPhilsopher ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{LHPhilsopher}}%
 \@x{\@s{103.63} \.{\land} \.{\land} first \.{'} \.{=} [ first {\EXCEPT}
 {\bang} [ self ] \.{=} right [ self ] ]}%
 \@x{\@s{114.74} \.{\land} second \.{'} \.{=} [ second {\EXCEPT} {\bang} [
 self ] \.{=} left [ self ] ]}%
 \@x{\@s{114.74} \.{\land} stack \.{'} \.{=} [ stack {\EXCEPT} {\bang} [ self
 ] \.{=} {\langle} [ procedure \.{\mapsto}\@s{4.1}\@w{eat} ,\,}%
\@x{\@s{278.94} pc\@s{31.67} \.{\mapsto}\@s{3.78}\@w{Done} ,\,}%
\@x{\@s{278.94} first\@s{23.24} \.{\mapsto}\@s{4.1} first [ self ] ,\,}%
 \@x{\@s{278.94} second\@s{11.98} \.{\mapsto}\@s{4.1} second [ self ] ]
 {\rangle}}%
\@x{\@s{276.38} \.{\circ} stack [ self ] ]}%
 \@x{\@s{103.63} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{PickUpFirst} ]}%
 \@x{\@s{103.63} \.{\land} {\UNCHANGED} {\langle} sticks ,\, left\_ ,\,
 right\_ ,\, left ,\, right {\rangle}}%
\@pvspace{8.0pt}%
\@x{ lh\_philosopher ( self ) \.{\defeq} LHPhilsopher ( self )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self \.{\in} ProcSet \.{:} eat ( self ) )}%
 \@x{\@s{47.82} \.{\lor} ( \E\, self \.{\in} 1 \.{\dotdot} ( NPhilosophers
 \.{-} 1 ) \.{:} philosopher ( self ) )}%
 \@x{\@s{47.82} \.{\lor} ( \E\, self \.{\in} \{ NPhilosophers \} \.{:}
 lh\_philosopher ( self ) )}%
\@x{\@s{47.82} \.{\lor}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 ...
 vars}}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} 1 \.{\dotdot} ( NPhilosophers
 \.{-} 1 ) \.{:} {\WF}_{ vars} ( philosopher ( self ) ) \.{\land} {\WF}_{
 vars} ( eat ( self ) )}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} \{ NPhilosophers \} \.{:} {\WF}_{
 vars} ( lh\_philosopher ( self ) ) \.{\land} {\WF}_{ vars} ( eat ( self ) )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{ Liveness \.{\defeq}}%
\@x{\@s{8.2} \A\, p \.{\in} ProcSet \.{:}}%
\@x{\@s{16.4} {\Diamond} ( pc [ p ] \.{=}\@w{Eat} )}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 16 12:49:53 \ensuremath{EDT} 2018 by \ensuremath{benjamin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} \ensuremath{Aug} 16
 11:22:55 \ensuremath{EDT} 2018 by \ensuremath{benjamin
}%
\end{cpar}%
\end{lcom}%
\end{document}
