...
vars == << alice, bob, total, pc, transfer >>
...
CheckAndWithdraw(self) == /\ pc[self] = "CheckAndWithdraw"
                          /\ IF alice >= transfer[self]
                                ...
                                ELSE /\ pc' = [pc EXCEPT ![self] = "Done"]
                                     /\ alice' = alice
                          /\ UNCHANGED << bob, total, transfer >>

Depoist(self) == /\ pc[self] = "Depoist"
                 /\ bob' = bob + transfer[self]
                 /\ pc' = [pc EXCEPT ![self] = "Done"]
                 /\ UNCHANGED << alice, total, transfer >>
...
\* Last modified Tue Aug 14 11:39:21 EDT 2018 by benjamin
