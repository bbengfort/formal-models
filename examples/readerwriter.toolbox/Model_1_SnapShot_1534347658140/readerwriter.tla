...
HandleValue == /\ pc["reader"] = "HandleValue"
               /\ \/ /\ pc' = [pc EXCEPT !["reader"] = "ReadSuccess"]
                  \/ /\ pc' = [pc EXCEPT !["reader"] = "ReadFailure"]
               /\ UNCHANGED << queue, to_write, val >>

ReadSuccess == /\ pc["reader"] = "ReadSuccess"
               /\ TRUE
               /\ pc' = [pc EXCEPT !["reader"] = "EndRead"]
               /\ UNCHANGED << queue, to_write, val >>

ReadFailure == /\ pc["reader"] = "ReadFailure"
               /\ Len(queue) < MaxQueueSize
...
reader == Read \/ HandleValue \/ ReadSuccess \/ ReadFailure \/ EndRead
...
\* Last modified Wed Aug 15 11:40:53 EDT 2018 by benjamin
