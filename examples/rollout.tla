...
define
  \* Ensure that servers have the correct version and status and that load_balancer is made up of servers.  
  TypeInvariant == 
  ...
  \* Eventually, all servers are ready and at the new version and in load balancer
  UpdateSuccessful == 
    <>[](
      \A s \in Servers: 
        /\ status[s] = "ready" 
...
\* Last modified Thu Aug 16 14:21:18 EDT 2018 by benjamin
